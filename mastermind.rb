class Game
    ...
    def check(guess)
        ...
        for i in 0..(guess.length-1)
            ...
            puts "Loop number #{i}"
            puts "Right position = #{right_position}"
            puts "Right value = #{right_value}"
        end
        puts "After the loop, position = #{right_position}"
        puts "After the loop, value = #{right_value}"
